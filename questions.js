...
  options: [
    { text: "靜謐花園伏著一頭黑獅，牠睜開眼——玫瑰瞳鈴眼",                   scores: { BEAST: 4 } },
    { text: "高塔最深處的惡龍抬頭，掏出烏鴉製造鴉驚水",                     scores: { CROW: 2, THORN: 1 } },
    { text: "滾輪小老鼠簇擁著一支黑色魔笛，搶奪吹笛權",                     scores: { PIP: 3 } },
    { text: "空無一人的大廳裡只有一面鏡子與一道出口，你突然覺得現在回頭也許還不算太晚", scores: { ESC: 1 } },
  ]
},
...
  options: [
    { text: "你的心臟，因為黑市可以賣五十萬美金",           scores: { BRO: 1 } },
    { text: "你的影子，那不只是影子那還是老攻啊",           scores: { SHA: 2 } },
    { text: "你的臉，雖然不要臉的話，可以賺更多",           scores: { CIND: 3 } },
...
  options: [
    { text: "回頭，夢該醒了；有些童話適合付錢觀看就好",                           scores: { ESC: 1 } },
    { text: "留下，哪怕有惡龍、野獸，你也想知道故事會不會去到更遠的地方",         scores: { BEAST: 3, THORN: 1 } },
